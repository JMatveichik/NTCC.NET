...
{
    public class StageCooling : StageBase
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public StageCooling(string id) : base(id)
        {
            ContentID = "TREATMENT";
            /*
            StageAlarmTests = new TestGroup("Cooling", false, "Alarm")
            {
            ...
            StageWarningTests = new TestGroup("Cooling", true, "Warnings")
            {
        ...
        protected override StageResult Prepare()
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                ...
                durationWnd = new StageDurationDialog
                {
                    ...
                    Message = App.Localize("msgCoolingDuration"),
                    Caption = App.Localize("OperationCooling"),
                ...
                doCooling = durationWnd.DialogResult;
            }
            );
        ...
        protected override StageResult Main(CancellationToken cancel)
        {
            ...
            Facility.CurrentOperation = App.Localize("OperationCooling");
            Facility.LastMessage = App.Localize("msgCoolingPrepareFor");
